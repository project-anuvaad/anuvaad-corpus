...
lookup_data_string = '{"reportable":  "परिव्यापक","in the supreme court of india civil original jurisdiction" : "भारत '\
                     'के उच्चतम न्यायालय में सिविल अधिकारिताएं","in the supreme court of india criminal/civil ' \
                     'original jurisdiction": "भारत के उच्चतम न्यायालय में दांडिक/सिविल अधिकारिताएं","in the supreme ' \
                     'court of india criminal original jurisdiction": "भारत के उच्चतम न्यायालय में दांडिक ' \
                     'अधिकारिताएं","union of india" : "भारतीय संघ","petitioner" : "याचिकाकर्ता","with": "साथ में",' \
                     '"shreya singhal" : "श्रेया सिंघल","versus" : "बनाम","respondent" : "उत्तरदाता","judgment": ' \
                     '"निर्णय","... respondent"  : "उत्तरदाता","writ petition (criminal)": "रिट याचिका (आपराधिक) ' \
                     'सं.","civil appeal" : "सिविल अपील सं.","writ petition (civil)" : "रिट याचिका (सिविल) सं.",' \
                     '"contempt petition(civil)" : "संपर्क याचिका (सिविल) सं.","special leave petition(criminal)": ' \
                     '"विशेष अवकाश याचिका (अपराधी) सं.","in": "मे","a.k. sikri,j" : "ए.के. सिकरि, जे","transferred ' \
                     'petition (civil)" : "स्थानांतरित याचिका सं.","civil appellate jurisdiction" : "सिविल अपील ' \
                     'न्यायिक क्षेत्र"} '
